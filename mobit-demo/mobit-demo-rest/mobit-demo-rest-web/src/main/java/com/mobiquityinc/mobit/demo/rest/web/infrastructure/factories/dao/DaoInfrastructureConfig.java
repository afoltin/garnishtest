...
public class DaoInfrastructureConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean() throws SQLException {
        ...
        factory.setTypeAliasesPackage("com.mobiquityinc.mobit.demo.rest.web.dao.model");
        factory.setTypeAliasesPackage("com.mobiquityinc.mobit.demo.rest.web.dao.model");
    ...
    private DataSource createDataSource() throws SQLException {
        ...
        dataSource.setUrl("jdbc:p6spy:h2:mem:mobit-demo-rest;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=false;INIT=CREATE SCHEMA IF NOT EXISTS mobit_demo_rest_schema\\; SET SCHEMA mobit_demo_rest_schema");
    ...
    private void populateDatabase(final DataSource dataSource) throws SQLException {
        final ResourceDatabasePopulator databasePopulator = new ResourceDatabasePopulator(
                new ClassPathResource("db/mobit-demo-rest-db-schema.sql")
        );
    ...
    // use url: jdbc:h2:tcp://localhost:9092/mem:mobit-demo-rest
