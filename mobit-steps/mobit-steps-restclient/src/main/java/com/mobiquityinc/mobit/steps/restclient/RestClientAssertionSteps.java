...
import com.mobiquityinc.mobit.modules.it.test_utils_json.compare.SmartJsonAssert;
...
public final class RestClientAssertionSteps {
    ...
    @Autowired
    public RestClientAssertionSteps(@NonNull @Qualifier("mobitStepsRestClient_responseManager") final ApiClientResponseManager apiClientResponseManager,
                                    @NonNull @Qualifier("mobitStepsRestClient_smartJsonAssert") final SmartJsonAssert smartJsonAssert) {
