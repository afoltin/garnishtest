package com.mobiquityinc.mobit.steps.db;

import com.mobiquityinc.mobit.modules.generic.db_util.scripts.DbScriptsExecutor;
import com.mobiquityinc.mobit.modules.it.test_utils_dbunit.compare.database.DbUnitDatabaseComparer;
import com.mobiquityinc.mobit.modules.it.test_utils_dbunit.insert.DbUnitInserter;
...
public class DatabaseSteps {
    ...
    @Autowired
    public DatabaseSteps(@NonNull @Qualifier("mobitStepsDb_dbScriptsExecutor")      final DbScriptsExecutor dbScriptsExecutor,
                         @NonNull @Qualifier("mobitStepsDb_dbUnitInserter")         final DbUnitInserter dbUnitInserter,
                         @NonNull @Qualifier("mobitStepsDb_dbUnitDatabaseComparer") final DbUnitDatabaseComparer dbUnitDatabaseComparer,
                         ...
                         @NonNull @Value("#{mobitStepsDb_cleanupScripts}")          final List<Resource> cleanupScripts) {
