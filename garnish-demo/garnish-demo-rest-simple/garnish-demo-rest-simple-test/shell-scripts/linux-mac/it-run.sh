...
rm -rf "garnish-demo-rest-simple-test/target/cucumber/" 2> /dev/null
...
mvn verify -am -pl garnish-demo-rest-simple-web/,garnish-demo-rest-simple-test/ -DrunIntegrationTests "$@"
