...
public class DaoInfrastructureConfig {
    ...
    private DataSource createDataSource() throws SQLException {
        ...
        dataSource.setUrl("jdbc:p6spy:h2:mem:garnishtest-demo-rest-complex;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=false;INIT=CREATE SCHEMA IF NOT EXISTS garnish_demo_rest_complex_schema\\; SET SCHEMA garnish_demo_rest_complex_schema");
    ...
    private void populateDatabase(final DataSource dataSource) throws SQLException {
        final ResourceDatabasePopulator databasePopulator = new ResourceDatabasePopulator(
                new ClassPathResource("db/garnishtest-demo-rest-complex-db-schema.sql")
        );
    ...
    // use url: jdbc:h2:tcp://localhost:9092/mem:garnishtest-demo-rest-complex
