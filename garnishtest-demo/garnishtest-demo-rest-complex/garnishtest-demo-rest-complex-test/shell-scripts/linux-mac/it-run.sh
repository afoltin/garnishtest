...
rm -rf "garnishtest-demo-rest-complex-test/target/cucumber/" 2> /dev/null
...
mvn verify -am -pl garnishtest-demo-rest-complex-web/,garnishtest-demo-rest-complex-test/ -DrunIntegrationTests "$@"
