...
rm -rf "garnishtest-demo-rest-simple-test/target/cucumber/" 2> /dev/null
...
mvn verify -am -pl garnishtest-demo-rest-simple-web/,garnishtest-demo-rest-simple-test/ -DrunIntegrationTests "$@"
