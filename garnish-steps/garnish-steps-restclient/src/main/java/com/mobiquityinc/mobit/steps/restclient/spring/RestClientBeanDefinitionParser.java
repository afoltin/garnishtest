...
import com.mobiquityinc.mobit.modules.generic.httpclient.request_preparer.impl.CompositeHttpRequestPreparer;
...
import com.mobiquityinc.mobit.steps.restclient.auth.provider.impl.NoOpRestClientAuthenticationProvider;
import com.mobiquityinc.mobit.steps.restclient.spring.model.RequestPreparerElement;
import com.mobiquityinc.mobit.steps.restclient.spring.model.RestClientElement;
...
public final class RestClientBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public static final String ROOT_BEAN_ID = "mobitStepsRestClient_httpClient";
    public static final String AUTHENTICATION_HTTP_REQUEST_PREPARER_BEAN_ID = "mobitStepsRestClient_authenticationHttpRequestPreparer";
